...
The threats we face — climate tipping points, transformative AI, biological risks, economic fragility — share a common feature. They don't care about our ideological categories. They don't wait for consensus. And they punish inaction faster than our governance structures can iterate.

We have built a civilisation of extraordinary technical capability on frameworks of practical reason that exclude half of what makes coordination actually work: empathy, situated wisdom, the capacity to hold genuine disagreement without either collapsing into 'anything goes' or retreating into 'my tribe, right or wrong.' We've narrowed our understanding of what counts as rational to the point where the only coordination mechanisms we trust are the ones that leave out everything distinctly human about how we actually solve problems together.

It's a failure of imagination, compounded by centuries of institutional inertia.
...
This is early-stage work. It will be wrong in many places. It will be incomplete for years. It is being built in the open because the kind of coordination it describes can only be developed through the kind of coordination it describes: people with different perspectives, different expertise and different convictions contributing to something larger than any single viewpoint.

## The Stakes

This tests a conviction: that humanity can become the kind of species capable of coordinating across genuine difference. Not despite our plurality, but through it.

If that conviction is right, the implications extend far beyond any single policy domain. If it's wrong, we need to know that too, clearly and honestly, so we can find what actually works before the window closes.

The implications are civilisational.
