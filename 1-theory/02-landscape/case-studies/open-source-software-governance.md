...
**Scale:** Global / Organisational
**Verdict:** Success
**Referenced in:** [Top-Down and Bottom-Up](../01-top-down-bottom-up.md), [Where It Works](../02-where-it-works.md)
...
- Coordination without convergence: contributors don't need shared motivation, only shared protocol
- Distributed intelligence with institutional scaffolding: issues and PRs are bottom-up, maintainer review is top-down
- Iterative trust-building: contributions build reputation over time
- Transparency of mechanism: version control makes every decision visible and reversible
- Preservation of exit: anyone can fork the project if they disagree with its direction
...
- Linux kernel governance documentation
- GitHub's own research on open-source community dynamics
