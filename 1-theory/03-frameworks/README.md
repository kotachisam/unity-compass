...
**[What Works and Why](02-what-works-and-why.md)** examines what successful coordination without convergence looks like in practice. Ostrom's commons-governance research transfers partially but not fully to the harder cases. Six worked examples (Montreal Protocol, open-source governance, Irish Citizens' Assembly, reactor safety culture, IETF rough consensus, restorative justice) produce a common architecture of five recurring elements.
