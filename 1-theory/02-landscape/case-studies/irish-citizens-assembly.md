...
**Referenced in:** [Current Approaches](../04-current-approaches.md), [Where It Works](../02-where-it-works.md)
...
- Sortition (random selection) produced a body more representative than any elected parliament
- Structured deliberation with expert input allowed nuanced engagement with complex issues
- Separation from electoral incentives freed participants from partisan identity
- Government commitment to act on recommendations gave the process legitimacy and stakes
- Principles of openness, fairness, equality of voice, respect and collegiality governed the process
...
- Farrell, David M. et al. on the Irish model in *Frontiers in Political Science* (2020)
- OECD reports on deliberative democracy
- DemocracyNext and Hélène Landemore's work
